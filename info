...
then
    ...
    curl -s --max-time 10 -o ioping.static https://raw.githubusercontent.com/n-st/nench/master/ioping.static
...
then
    ...
    printf '    Online.net (France):        '
    download_benchmark -4 http://ping.online.net/100Mo.dat | \
        Bps_to_MiBps

    printf '    OVH BHS (Canada):           '
    download_benchmark -4 http://speedtest-bhs.as16276.ovh/files/100Mio.dat | \
        Bps_to_MiBps

    printf '    Vultr (Chicago):            '
    download_benchmark -4 http://il-us-ping.vultr.com/vultr.com.100MB.bin | \
        Bps_to_MiBps

    printf '    Vultr (Los Angeles):        '
    download_benchmark -4 http://lax-ca-us-ping.vultr.com/vultr.com.100MB.bin | \
        Bps_to_MiBps

    printf '    Vultr (Sydney):             '
    download_benchmark -4 http://syd-au-ping.vultr.com/vultr.com.100MB.bin | \
        Bps_to_MiBps

    printf '    Vultr (Tokyo):              '
    download_benchmark -4 http://hnd-jp-ping.vultr.com/vultr.com.100MB.bin | \
        Bps_to_MiBps
    ...
    printf '    Vultr (Mumbai):             '
    download_benchmark -4 https://bom-in-ping.vultr.com/vultr.com.100MB.bin | \
        Bps_to_MiBps

    printf '    Linode (Chicago):           '
    download_benchmark -4 http://speedtest.chicago.linode.com/100MB-chicago.bin | \
        Bps_to_MiBps

    printf '    Linode (Los Angeles):       '
    download_benchmark -4 http://speedtest.los-angeles.linode.com/100MB-los-angeles.bin | \
        Bps_to_MiBps

    printf '    Linode (Sydney):            '
    download_benchmark -4 http://speedtest.syd1.linode.com/100MB-syd1.bin | \
        Bps_to_MiBps

    printf '    Linode (Tokyo):             '
    download_benchmark -4 http://speedtest.tokyo2.linode.com/100MB-tokyo2.bin | \
        Bps_to_MiBps

    printf '    Linode (Singapore):         '
    download_benchmark -4 http://speedtest.singapore.linode.com/100MB-singapore.bin | \
        Bps_to_MiBps

    printf '    Linode (Jakarta):           '
    download_benchmark -4 http://speedtest.jakarta.linode.com/100MB-jakarta.bin | \
        Bps_to_MiBps

    printf '    Linode (Mumbai):            '
    download_benchmark -4 http://speedtest.mumbai1.linode.com/100MB-mumbai1.bin | \
        Bps_to_MiBps

    printf '    RamNode (New York):         '
    download_benchmark -4 http://lg.nyc.ramnode.com/static/100MB.test | \
        Bps_to_MiBps

    printf '    RamNode (Los Angeles):      '
    download_benchmark -4 http://lg.la.ramnode.com/static/100MB.test | \
        Bps_to_MiBps

    printf '    RamNode (Seattle):          '
    download_benchmark -4 http://lg.sea.ramnode.com/static/100MB.test | \
        Bps_to_MiBps

    printf '    RamNode (Atlanta):          '
    download_benchmark -4 http://lg.atl.ramnode.com/static/100MB.test | \
        Bps_to_MiBps

    printf '    RamNode (Alblasserdam):     '
    download_benchmark -4 http://lg.nl.ramnode.com/static/100MB.test | \
        Bps_to_MiBps

    printf '    VNPT (Ha Noi):              '
    download_benchmark -4 http://speedtest1.vtn.com.vn/speedtest/random4000x4000.jpg | \
        Bps_to_MiBps

    printf '    VNPT (Da Nang):             '
    download_benchmark -4 http://speedtest5.vtn.com.vn/speedtest/random4000x4000.jpg | \
        Bps_to_MiBps

    printf '    VNPT (HCM):                 '
    download_benchmark -4 http://speedtest3.vtn.com.vn/speedtest/random4000x4000.jpg | \
        Bps_to_MiBps

    printf '    Viettel (Ha Noi):           '
    download_benchmark -4 http://speedtestkv1a.viettel.vn/speedtest/random4000x4000.jpg | \
        Bps_to_MiBps

    printf '    Viettel (Da Nang):          '
    download_benchmark -4 http://speedtestkv2a.viettel.vn/speedtest/random4000x4000.jpg | \
        Bps_to_MiBps

    printf '    Viettel (HCM):              '
    download_benchmark -4 http://speedtestkv3a.viettel.vn/speedtest/random4000x4000.jpg | \
        Bps_to_MiBps
