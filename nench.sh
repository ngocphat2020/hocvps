...
then
    ...
    download_benchmark -4 https://il-us-ping.vultr.com/vultr.com.100MB.bin | \
        Bps_to_MiBps

    printf '    Vultr (Los Angeles):        '
    download_benchmark -4 https://lax-ca-us-ping.vultr.com/vultr.com.100MB.bin | \
        Bps_to_MiBps

    printf '    Vultr (Tokyo):              '
    download_benchmark -4 https://hnd-jp-ping.vultr.com/vultr.com.100MB.bin | \
        Bps_to_MiBps

    printf '    Vultr (Seoul):              '
    download_benchmark -4 https://sel-kor-ping.vultr.com/vultr.com.100MB.bin | \
        Bps_to_MiBps

    printf '    Vultr (Singapore):          '
    download_benchmark -4 https://sgp-ping.vultr.com/vultr.com.100MB.bin | \
        Bps_to_MiBps
    ...
    download_benchmark -4 https://lg.nyc.ramnode.com/static/100MB.test | \
        Bps_to_MiBps

    printf '    RamNode (Los Angeles):      '
    download_benchmark -4 https://lg.la.ramnode.com/static/100MB.test | \
        Bps_to_MiBps
    ...
    printf '    Bizfly Cloud:              '
    download_benchmark -4 https://mirror.bizflycloud.vn/centos/7.9.2009/os/x86_64/isolinux/initrd.img | \
        Bps_to_MiBps
