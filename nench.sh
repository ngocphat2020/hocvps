...
download_benchmark()
{
    curl --insecure --max-time 10 -so /dev/null -w '%{speed_download}\n' "$@"
}
...
then
    ...
    printf '    Vultr (Seoul):              '
    download_benchmark -4 http://sel-kor-ping.vultr.com/vultr.com.100MB.bin | \
        Bps_to_MiBps
    ...
    printf '    Linode (Tokyo):             '
    download_benchmark -4 http://speedtest.tokyo2.linode.com/100MB-tokyo.bin | \
        Bps_to_MiBps
    ...
    printf '    Colocrossing (Chicago):     '
    download_benchmark -4 http://lg.chi.colocrossing.com/100MB.test | \
        Bps_to_MiBps

    printf '    Colocrossing (Los Angeles): '
    download_benchmark -4 http://lg.la.colocrossing.com/100MB.test | \
        Bps_to_MiBps
    ...
    printf '    Viettel Cloud:              '
    download_benchmark -4 http://mirror.viettelcloud.vn/centos/7.9.2009/os/x86_64/isolinux/initrd.img | \
        Bps_to_MiBps

    printf '    Bizfly Cloud:               '
    download_benchmark -4 http://mirror.bizflycloud.vn/centos/7.9.2009/os/x86_64/isolinux/initrd.img | \
        Bps_to_MiBps
